...
Parte de la información que se tiene que enviar a la web se puede obtener de los eventos que se reciben en el servicio, pero la otra parte es necesario acceder a la base de datos para obtenerla. A continuación se exponen los diagramas de la base de datos utilizados en el contexto de este proyecto.
\begin{itemize}
