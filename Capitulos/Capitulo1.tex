...
\begin{itemize}
    ...
    \end{enumerate}
    \item \textbf{Alarmas}: son alertas generadas por los pacientes cuando hay una situación de emergencia desde los terminales que se encuentran en las habitaciones. Pueden ser codificadas por el primer trabajador que se ha identificado en ese terminal.
    ...
    \begin{enumerate}
        ...
        \item Aceptada: un trabajador es consciente de la existencia de esa alarma mediante su identificación en el terminal y queda pendiente de ser atendida.
        \item Atendida: la alarma queda pendiente de ser codificada por el trabajador que la ha aceptado.
    \end{enumerate}    
\end{itemize}
