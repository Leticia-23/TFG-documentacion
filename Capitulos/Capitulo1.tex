...
Por otro lado, este proyecto se está desarrollando de tal forma que la estudiante trabaja para la empresa de forma remota, estando la sede de la empresa en Zaragoza, España y la estudiante en Kaunas, Lituania. Por esta razón, cobran mayor relevancia las herramientas de trabajo utilizadas para mantener la comunicación con la empresa son \textit{Gmail}, \textit{Google Chat} y te \textit{Google Meet} para realizar las reuniones con el tutor en la empresa.
